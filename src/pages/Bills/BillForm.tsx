...
import type { CreateBill, Source } from "@/types/api";
...
interface BillFormProps {
  ...
  onClose: () => void;
  onSubmit: (data: CreateBill) => void;
  serverError?: unknown;
  sources: Source[];
}

export function BillForm({ isSubmitting, onClose, onSubmit, serverError, sources }: BillFormProps) {
  ...
  const processSubmit = useCallback(
    (values: FormValues) => {
      ...
      if (recurring) {
        payload.recurrence = {
          intervalUnit: values.intervalUnit as CreateBill["recurrence"] extends undefined ? never : NonNullable<CreateBill["recurrence"]>["intervalUnit"],
